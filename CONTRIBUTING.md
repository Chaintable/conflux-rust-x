...
This repository is a **fork**: upstream [Conflux-Chain/conflux-rust](https://github.com/Conflux-Chain/conflux-rust)
...
a general-purpose fork of Conflux-Chain/conflux-rust.
...
* Release tags follow `v<base-version>-ct.N` (`ct` = Chaintable; e.g.
  `v3.0.1-ct.2`); a GitHub Release publishes the versioned images
...
terms as this repository — see [LICENSE](./LICENSE) (GPL-3.0).
